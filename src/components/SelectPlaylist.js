...
function SelectPlaylistComponent({ trackId }) {
    ...
    useEffect(() => {
        axios.get('http://localhost:8081/api/playlists', { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } })
    ...
    const handleAddToPlaylist = () => {
        ...
        axios.post('http://localhost:8081/api/playlists/add-track', {
